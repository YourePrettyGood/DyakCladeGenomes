...
my_percentage <- c(98.2, 0.6, 0.6, 0.6, 97.5, 0.9, 1.0, 0.6, 98.2, 0.7, 0.6, 0.5, 93.9, 2.4, 2.2, 1.5, 95.7, 2.6, 0.9, 0.8, 98.2, 0.5, 0.8, 0.5)
my_values <- c(2750, 17, 17, 15, 2728, 25, 28, 18, 2748, 19, 17, 15, 2629, 67, 62, 41, 2678, 73, 25, 23, 2748, 14, 21, 16)
