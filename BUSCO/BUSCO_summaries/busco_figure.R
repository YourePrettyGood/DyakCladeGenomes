...
my_species <- c('Dyak_Tai18E2', 'Dyak_Tai18E2', 'Dyak_Tai18E2', 'Dyak_Tai18E2', 'Dsim_w501', 'Dsim_w501', 'Dsim_w501', 'Dsim_w501', 'Dsan_STOCAGO1482', 'Dsan_STOCAGO1482', 'Dsan_STOCAGO1482', 'Dsan_STOCAGO1482', 'Dyak_NY73PB', 'Dyak_NY73PB', 'Dyak_NY73PB', 'Dyak_NY73PB', 'Dtei_GT53w', 'Dtei_GT53w', 'Dtei_GT53w', 'Dtei_GT53w', 'Dyak_caf1', 'Dyak_caf1', 'Dyak_caf1', 'Dyak_caf1', 'Dmel_ISO1', 'Dmel_ISO1', 'Dmel_ISO1', 'Dmel_ISO1', 'Dyak_Miller', 'Dyak_Miller', 'Dyak_Miller', 'Dyak_Miller')
...
my_percentage <- c(98.2, 0.6, 0.6, 0.6, 97.9, 0.5, 1.0, 0.6, 97.4, 0.6, 1.1, 0.9, 98.1, 0.7, 0.6, 0.6, 94.4, 2.1, 2.1, 1.4, 95.7, 2.6, 0.9, 0.8, 98.2, 0.5, 0.8, 0.5, 97.9, 0.5, 0.8, 0.8)
my_values <- c(2750, 17, 17, 15, 2741, 13, 27, 18, 2726, 17, 30, 26, 2747, 19, 18, 15, 2641, 60, 59, 39, 2678, 73, 25, 23, 2748, 14, 21, 16, 2741, 15, 23, 20)
...
figure <- ggplot() + 
  ...
  for(i in rev(c(1:length(levels(my_species))))){
    ...
    annotate("text", label=paste("C:", detailed_values[1] + detailed_values[2], " [S:", detailed_values[1], ", D:", detailed_values[2], "], F:", detailed_values[3], ", M:", detailed_values[4], ", n:", total_buscos, sep=""), 
             y=99, x = i, size = labsize*4*my_size_ratio, colour = "black", hjust=1, family=my_family)
  }
