...
# Output
my_output <- paste("BUSCO_txome_summaries/","busco_figure.png",sep="/") 
my_width <- 20
my_height <- 15
my_unit <- "cm"
...
my_species <- c('Dyak_Tai18E2', 'Dyak_Tai18E2', 'Dyak_Tai18E2', 'Dyak_Tai18E2', 'Dsim_w501', 'Dsim_w501', 'Dsim_w501', 'Dsim_w501', 'Dsan_STOCAGO1482', 'Dsan_STOCAGO1482', 'Dsan_STOCAGO1482', 'Dsan_STOCAGO1482', 'Dyak_NY73PB', 'Dyak_NY73PB', 'Dyak_NY73PB', 'Dyak_NY73PB', 'Dtei_GT53w', 'Dtei_GT53w', 'Dtei_GT53w', 'Dtei_GT53w', 'Dyak_caf1', 'Dyak_caf1', 'Dyak_caf1', 'Dyak_caf1', 'Dmel_ISO1', 'Dmel_ISO1', 'Dmel_ISO1', 'Dmel_ISO1')
...
my_percentage <- c(94.5, 0.5, 2.5, 2.5, 97.9, 0.5, 0.9, 0.7, 92.5, 0.5, 4.0, 3.0, 92.8, 0.5, 3.5, 3.2, 87.1, 2.6, 6.5, 3.8, 95.6, 2.5, 0.9, 1.0, 98.6, 0.6, 0.4, 0.4)
my_values <- c(2644, 14, 71, 70, 2740, 15, 24, 20, 2588, 13, 112, 86, 2598, 15, 98, 88, 2438, 74, 183, 104, 2675, 69, 25, 30, 2759, 16, 12, 12)
