...
my_percentage <- c(94.4, 0.5, 2.5, 2.6, 93.1, 0.8, 3.4, 2.7, 94.1, 0.5, 2.9, 2.5, 87.6, 2.7, 6.5, 3.2, 95.6, 2.5, 0.9, 1.0, 98.6, 0.6, 0.4, 0.4)
my_values <- c(2642, 13, 69, 75, 2607, 23, 95, 74, 2635, 14, 82, 68, 2452, 75, 182, 90, 2675, 69, 25, 30, 2759, 16, 12, 12)
