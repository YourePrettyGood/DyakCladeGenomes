...
# Output
my_output <- paste("BUSCO_proteome_summaries/","busco_figure.png",sep="/") 
my_width <- 20
my_height <- 15
my_unit <- "cm"
...
my_species <- c('Dyak_Tai18E2', 'Dyak_Tai18E2', 'Dyak_Tai18E2', 'Dyak_Tai18E2', 'Dsan_STOCAGO1482', 'Dsan_STOCAGO1482', 'Dsan_STOCAGO1482', 'Dsan_STOCAGO1482', 'Dyak_NY73PB', 'Dyak_NY73PB', 'Dyak_NY73PB', 'Dyak_NY73PB', 'Dtei_GT53w', 'Dtei_GT53w', 'Dtei_GT53w', 'Dtei_GT53w', 'Dyak_caf1', 'Dyak_caf1', 'Dyak_caf1', 'Dyak_caf1', 'Dmel_ISO1', 'Dmel_ISO1', 'Dmel_ISO1', 'Dmel_ISO1')
...
my_percentage <- c(95.2, 0.6, 1.9, 2.3, 94.1, 0.9, 2.8, 2.2, 95.3, 0.7, 2.2, 1.8, 88.9, 2.7, 5.8, 2.6, 95.1, 2.5, 0.9, 1.5, 98.5, 0.6, 0.4, 0.5)
my_values <- c(2664, 18, 52, 65, 2633, 26, 77, 63, 2667, 19, 61, 52, 2489, 76, 161, 73, 2662, 70, 26, 41, 2758, 16, 12, 13)
